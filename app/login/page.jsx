            ...
            <div className="rounded-3xl border border-white/60 bg-white/80 p-8 shadow-[0_20px_60px_-30px_rgba(15,23,42,0.35)] backdrop-blur">
              ...
              <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className={`${sora.className} flex w-full items-center justify-center rounded-2xl bg-slate-900 px-4 py-3 text-sm font-semibold text-white shadow-md transition hover:-translate-y-0.5 hover:bg-slate-800 hover:shadow-lg disabled:cursor-not-allowed disabled:opacity-70`}
                >
