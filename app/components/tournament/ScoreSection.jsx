    ...
    <div className="grid gap-3">
      ...
      <Card>
        <CardContent className="p-0">
          <div className="p-3 bg-blue-700 text-white font-extrabold">
          ...
          <div className="bg-white">
            {fixtures.map((m) => (
              <button
                ...
                onClick={() => setSelectedMatch(m.key)}
              >
              ...
              return (
                <div className="grid gap-3">
                  ...
                  {matchRows.map((row) => {
                    ...
                    return (
                    <div key={row.id} className="border rounded-2xl bg-white overflow-hidden">
                      ...
                      <div className="p-3 grid gap-2">
                        ...
                        <div>
                          <div className="text-xs font-bold text-slate-600 mb-1">Winner</div>
                          <Select
                  ...
                  {missingData ? (
                    <div className="text-xs text-amber-600">
                      Select players, enter scores, and choose a winner before viewing.
                    </div>
                  ) : (
                    <div className="text-xs text-slate-500">
                      Use the top tabs or global navigation to view standings.
                    </div>
                  )}
                </div>
              );
