export default function HeaderBar({ tournamentName, username, onLogout, onMenu }) {
  return (
    <div className="sticky top-0 z-20 bg-blue-700 text-white">
      <div className="px-4 py-3 grid items-center gap-2 sm:grid-cols-[auto_1fr_auto]">
        <div className="flex items-center gap-2">
          <button
            type="button"
            onClick={onMenu}
            className="rounded-full bg-white/15 px-3 py-2 text-xs font-semibold text-white hover:bg-white/25"
